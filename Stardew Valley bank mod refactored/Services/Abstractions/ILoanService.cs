...
public interface ILoanService
{
    ...
    LoanRecord? GetLoan(BankAccountData account, CompanyDefinition company);

    /// <summary>Get all independent loans for a specific company (matches by Name, OriginalName, and CropCode).</summary>
    IReadOnlyList<LoanRecord> GetCompanyLoans(BankAccountData account, CompanyDefinition company);
